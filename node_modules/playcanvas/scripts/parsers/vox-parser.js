...
(function (global, factory) {
	...
	var EventHandler = function () {
	  ...
	  ;
	  _proto._addCallback =
	  function _addCallback(name, callback, scope, once) {
	    if (once === void 0) {
	      once = false;
	    }
	  ...
	  ;
	  _proto.off =
	  function off(name, callback, scope) {
	    if (name) {
	      if (this._callbackActive[name] && this._callbackActive[name] === this._callbacks[name]) this._callbackActive[name] = this._callbackActive[name].slice();
	    } else {
	  ...
	  ;
	  _proto.fire =
	  function fire(name, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
	  ...
	  ;
	  _proto.once =
	  function once(name, callback, scope) {
	...
	var ComponentSystem = function (_EventHandler) {
	  ...
	  ;
	  _proto.cloneComponent =
	  function cloneComponent(entity, clone) {
	    var src = this.store[entity.getGuid()];
	    return this.addComponent(clone, src.data);
	  }

	  ;
	  _proto.initializeComponentData =
	  function initializeComponentData(component, data, properties) {
	    if (data === void 0) {
	      data = {};
	    }
