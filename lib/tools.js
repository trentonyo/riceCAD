...
const DEFAULT_PROJECT_DETAILS = require("./default_project.json")

let DEBUG = false

let setDebug = function (printDebugMessages) { DEBUG = printDebugMessages }
...
module.exports.DEFAULT_PROJECT_DETAILS = DEFAULT_PROJECT_DETAILS;
