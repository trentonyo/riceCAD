...
viewportSettingsForm.addEventListener('change', function ()
{
    ...
    {
        case "Black":
            setWorkingPlaneMaterial(blackMaterial)
            break
        case "Red":
            setWorkingPlaneMaterial(minecraftRed.getPhongMaterial())
            break
        case "Green":
            setWorkingPlaneMaterial(greenMaterial)
            break
        case "Brown":
            setWorkingPlaneMaterial(brownMaterial)
            break
        case "Blue":
            setWorkingPlaneMaterial(blueMaterial)
            break
        case "Purple":
            setWorkingPlaneMaterial(purpleMaterial)
            break
        case "Cyan":
            setWorkingPlaneMaterial(cyanMaterial)
            break
        case "Light Gray":
            setWorkingPlaneMaterial(lightGrayMaterial)
            break
        case "Gray":
            setWorkingPlaneMaterial(grayMaterial)
            break
        case "Pink":
            setWorkingPlaneMaterial(pinkMaterial)
            break
        case "Lime":
            setWorkingPlaneMaterial(limeMaterial)
            break
        case "Yellow":
            setWorkingPlaneMaterial(yellowMaterial)
            break
        case "Light Blue":
            setWorkingPlaneMaterial(lightBlueCode)
            break
        case "Magenta":
            setWorkingPlaneMaterial(magentaMaterial)
            break
        case "Orange":
            setWorkingPlaneMaterial(orangeMaterial)
            break
        case "White":
            setWorkingPlaneMaterial(whiteMaterial)
            break
    }
})
...
colorSettingsForm.addEventListener('change', function ()
{
    ...
    if(overridePalette.checked)
    {
        ...
        for(let code = 1; code <= 16; code++)
        {
            ...
            let value = parseInt(currentSetting.options[currentSetting.selectedIndex].value)
        ...
        for(let code = 1; code <= 16; code++)
        {
            let currentSetting = document.getElementById("color" + code)
            ...
            for(let digit = 1; digit <= 9; digit++)
            {
                if(uses[digit] === 0)
                {
                    ...
                    for(let option of currentSetting.options)
                    {
