...
const url = "/projectMetaData.json"
...
http.onreadystatechange = function (event)
{
    if(http.readyState === 4 && http.status === 200)
    {
        ...
        try
        {
            projectMetaData = JSON.parse(http.responseText)[currentProjectID]
    ...
    {
        console.log(`Still waiting on metadata request... (readyState: ${http.readyState}, status: ${http.status})`)
    }
}
