...
const url_postMetaData = "/projects/DEFAULT/addProject"

let tmpObject = {
    "title" : "Server Test Title",
    "description" : "What a kiss ass",
    "tags" : [
        {
...
document.getElementById("postProject").addEventListener("click", function (event) {
    axios.post(url_postMetaData, getCurrentMetaData())
})
