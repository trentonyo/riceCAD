...
let getCurrentMetaData = function ()
{
    ...
    {
        console.log("Pushing this label id to server as metadata:", checkedLabels[i].value)
...
let labelElements = document.querySelectorAll(".project_label input")
...
for (let i = 0; i < labelElements.length; i++) {
    labelElements[i].addEventListener("click", updateLabelStyle)
    updateLabelStyle(labelElements[i], true)
}
