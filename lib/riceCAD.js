//const pc = require("playcanvas")  //TODO Node is not defined on the client's side, how can we do this?
                                    // Previously, the library was in the directory
...
app.start()
document.getElementById("versionNumber").innerText = "v0.2.0"
...
viewportSettingsForm.addEventListener('change', function ()
{
    ...
    {
        case "Black":
            setBackgroundColor(minecraftBlack.getPCColor())
            break
        case "Red":
            setBackgroundColor(minecraftRed.getPCColor())
            break
        case "Green":
            setBackgroundColor(minecraftGreen.getPCColor())
            break
        case "Brown":
            setBackgroundColor(minecraftBrown.getPCColor())
            break
        case "Blue":
            setBackgroundColor(minecraftBlue.getPCColor())
            break
        case "Purple":
            setBackgroundColor(minecraftPurple.getPCColor())
            break
        case "Cyan":
            setBackgroundColor(minecraftCyan.getPCColor())
            break
        case "Light Gray":
            setBackgroundColor(minecraftLightGray.getPCColor())
            break
        case "Gray":
            setBackgroundColor(minecraftGray.getPCColor())
            break
        case "Pink":
            setBackgroundColor(minecraftPink.getPCColor())
            break
        case "Lime":
            setBackgroundColor(minecraftLime.getPCColor())
            break
        case "Yellow":
            setBackgroundColor(minecraftYellow.getPCColor())
            break
        case "Light Blue":
            setBackgroundColor(minecraftLightBlue.getPCColor())
            break
        case "Magenta":
            setBackgroundColor(minecraftMagenta.getPCColor())
            break
        case "Orange":
            setBackgroundColor(minecraftOrange.getPCColor())
            break
        case "White":
            setBackgroundColor(minecraftWhite.getPCColor())
            break
    }
    ...
    {
        case "Black":
            setWorkingPlaneMaterial(minecraftBlack.getPhongMaterial())
            break
        case "Red":
            setWorkingPlaneMaterial(minecraftRed.getPhongMaterial())
            break
        case "Green":
            setWorkingPlaneMaterial(minecraftGreen.getPhongMaterial())
            break
        case "Brown":
            setWorkingPlaneMaterial(minecraftBrown.getPhongMaterial())
            break
        case "Blue":
            setWorkingPlaneMaterial(minecraftBlue.getPhongMaterial())
            break
        case "Purple":
            setWorkingPlaneMaterial(minecraftPurple.getPhongMaterial())
            break
        case "Cyan":
            setWorkingPlaneMaterial(minecraftCyan.getPhongMaterial())
            break
        case "Light Gray":
            setWorkingPlaneMaterial(minecraftLightGray.getPhongMaterial())
            break
        case "Gray":
            setWorkingPlaneMaterial(minecraftGray.getPhongMaterial())
            break
        case "Pink":
            setWorkingPlaneMaterial(minecraftPink.getPhongMaterial())
            break
        case "Lime":
            setWorkingPlaneMaterial(minecraftLime.getPhongMaterial())
            break
        case "Yellow":
            setWorkingPlaneMaterial(minecraftYellow.getPhongMaterial())
            break
        case "Light Blue":
            setWorkingPlaneMaterial(minecraftLightBlue.getPhongMaterial())
            break
        case "Magenta":
            setWorkingPlaneMaterial(minecraftMagenta.getPhongMaterial())
            break
        case "Orange":
            setWorkingPlaneMaterial(minecraftOrange.getPhongMaterial())
            break
        case "White":
            setWorkingPlaneMaterial(minecraftWhite.getPhongMaterial())
            break
    }
})
