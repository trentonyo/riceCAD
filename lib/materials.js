...
Material.prototype.getHexColor = function ()
{
    let color = this.getPhongMaterial().diffuse
    return rgbToHex(color.r, color.g, color.b)
}

let rgbToHex = function (r, g, b)
{
    let R = "00" + Math.floor(255*r).toString(16)
    let G = "00" + Math.floor(255*g).toString(16)
    let B = "00" + Math.floor(255*b).toString(16)
