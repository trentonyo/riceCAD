...
templates['materialCard'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"material-settings-card card"
    ...
    + "\">\r\n\r\n"
    + ((stack1 = lookupProperty(helpers,"unless").call(alias1,(depth0 != null ? lookupProperty(depth0,"viewport") : depth0),{"name":"unless","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":4},"end":{"line":16,"column":15}}})) != null ? stack1 : "")
    + "\r\n</div>";
},"useData":true});
})();