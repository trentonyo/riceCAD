...
templates['projectCard'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"post\" data-title=\""
    ...
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(data && lookupProperty(data,"key")),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.program(5, data, 0),"data":data,"loc":{"start":{"line":7,"column":31},"end":{"line":7,"column":118}}})) != null ? stack1 : "")
    + ".png\" alt=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data,"loc":{"start":{"line":7,"column":129},"end":{"line":7,"column":138}}}) : helper)))
